    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <section className="text-center py-12">
        ...
        <h2 className="text-2xl md:text-3xl text-gray-400 mb-6">
          Guia Knight Club (Solo) - Rubinot
        </h2>
        <p className="text-gray-500 max-w-2xl mx-auto mb-8">
          A database definitiva para sua jornada: Hunts, Bosses, Imbuements, Linked Tasks e Ferramentas.
        </p>

        {/* Boosted Creature Widget */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {menuItems.map((item) => (
            <Link key={item.title} href={item.href}>
              <div className="card-glow p-6 cursor-pointer h-full hover:border-purple-500/50 transition-colors bg-[#1e1e2e]">
      ...
      <section className="py-8">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            <div key={hunt.name} className="card-glow p-5 bg-[#1e1e2e]">
