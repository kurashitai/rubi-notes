...
export const hunt = {
  "id": "vqbkz",
  "type": "Hunt",
  "title": "EK + ED on Gazer Spectres",
  "vocation": null,
  "teamSize": "duo",
  "image": "https://d13da7bn5qvpko.cloudfront.net/eyJidWNrZXQiOiJpbnRpYmlhLXByb2R1Y3Rpb24iLCJrZXkiOiJ1cGxvYWRzL2h1bnQvaW1hZ2UvNTAvZmdKeWdoaG0tdnFia3otbWluLnBuZyJ9",
  "minLevel": 180,
  "maxLevel": 400,
  "minProfitH": 150000,
  "maxProfitH": 500000,
  ...
  "videoId": "LTKp1eQvS28",
  "videoStartAt": null,
  "centerCoordinates": "32674,32651,7",
  "instructions": "<p>Very good hunt for DRUID + KNIGHT or PALADIN.</p>\n<p></p>\n<p>As gazers only attack who they see first, it's not necessary to use \"<em>exeta res</em>\", which is a good hunt for paladins to block (the only problem is hitting the creatures, as they take very little physical damage).</p>\n<p></p>\n<p>⚔️ EKs with winterblade do some damage!</p>\n<p>🔥 Always Imbued and with fire protection if possible.</p>",
  "createdAt": "2021-11-14T17:36:23.465Z",
  "updatedAt": "2024-03-17T23:20:50.564Z",
  "dungeon": {
    "id": 361,
    "type": "Dungeon",
  ...
  "lootUpdatedAt": "2021-11-17T01:13:08.016Z",
  "lootPendedUpdateAt": null,
  "publishedAt": "2021-11-14T17:36:23.465Z",
  "youtubeChannel": {
    "id": 3,
    "type": "YoutubeChannel",
    "name": "Guima Player",
